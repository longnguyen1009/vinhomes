<?php
/**
 * Template part for displaying a du an 26
 *
...
<div id="main" class="all_colors" data-scroll-offset="88">
    ...
    <?php get_template_part('templates-du_an/du_an', 'banner-even'); ?>

    <?php get_template_part('templates-du_an/du_an', 'des-even'); ?>
    
    <div id="av_section_2"
        class="avia-section main_color avia-section-default avia-no-border-styling  avia-bg-style-scroll  avia-builder-el-9  el_after_av_one_half  el_before_av_layout_row  gradient-background  container_wrap fullsize"
        style=" ">
        <div class="container">
                ...
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:10px; color:#ffffff;"
                            class="av-special-heading av-special-heading-h2 custom-color-heading blockquote modern-quote modern-centered  avia-builder-el-10  el_before_av_textblock  avia-builder-el-first  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Vị trí Vinhomes Green Villas</h2>
                        ...
                        <section class="av_textblock_section " itemscope="itemscope"
                            ...
                            <div class="avia_textblock  av_inherit_color " style="color:#ffffff; " itemprop="text">
                                <p>Vinhomes Green Villas tọa lạc trên đường Quang Tiến, phường Đại Mỗ, quận Nam Từ Liêm,
                                    ...
                                    đặc biệt là phường Tây Mỗ &amp; Đại Mỗ sẽ có nhiều dự án giao thông mới được triển
                                    khai như tuyến đường 70 mở rộng, tuyến đường Lê Trọng Tấn kéo dài đến vành đai 3, sẽ
                                    giúp cư dân rút ngắn thời gian di chuyển đến các khu vực trọng điểm trong thành phố.
                                </p>
                            </div>
                        </section>
    ...
    <div id="av-layout-grid-1"
        class="av-layout-grid-container entry-content-wrapper main_color av-flex-cells     avia-builder-el-12  el_after_av_section  el_before_av_heading  submenu-not-first container_wrap fullsize"
        style=" ">
        <div class="flex_cell no_margin av_one_full  avia-builder-el-13  avia-builder-el-no-sibling   av-zero-padding "
            style="vertical-align:top; padding:0; ">
            <div class="flex_cell_inner">
                <div class="avia-image-container  av-styling-    avia-builder-el-14  avia-builder-el-no-sibling  avia-align-center "
                ...
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:10px; "
                            class="av-special-heading av-special-heading-h2  blockquote modern-quote modern-centered  avia-builder-el-15  el_after_av_layout_row  el_before_av_layout_row  avia-builder-el-no-sibling  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Mặt bằng tổng thể Vinhomes Green
                                Villas</h2>
                            <div class="special-heading-border">
    ...
    <div id="av-layout-grid-2"
        class="av-layout-grid-container entry-content-wrapper main_color av-flex-cells     avia-builder-el-16  el_after_av_heading  el_before_av_section  submenu-not-first container_wrap fullsize"
        style=" ">
        <div class="flex_cell no_margin av_one_full  avia-builder-el-17  avia-builder-el-no-sibling   av-zero-padding "
            style="vertical-align:top; padding:0; ">
            <div class="flex_cell_inner">
                <div class="avia-image-container  av-styling-    avia-builder-el-18  avia-builder-el-no-sibling  avia-align-center "
                    itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
                    <div class="avia-image-container-inner">
    ...
    <div id="av_section_3"
        class="avia-section main_color avia-section-default avia-no-border-styling  avia-bg-style-scroll  avia-builder-el-19  el_after_av_layout_row  el_before_av_heading  gradient-background  container_wrap fullsize"
        style=" ">
        <div class="container">
            <div class="template-page content  av-content-full alpha units">
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:10px; color:#ffffff;"
                            class="av-special-heading av-special-heading-h2 custom-color-heading blockquote modern-quote modern-centered  avia-builder-el-20  el_before_av_textblock  avia-builder-el-first  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Không gian sống đậm chất <span
                                    class="special_amp">“</span>Eco<span class="special_amp">”</span></h2>
                            <div class="special-heading-border">
                                <div class="special-heading-inner-border" style="border-color:#ffffff"></div>
                            </div>
                        </div>
                        <section class="av_textblock_section " itemscope="itemscope"
                            itemtype="https://schema.org/CreativeWork">
                            <div class="avia_textblock  av_inherit_color " style="color:#ffffff; " itemprop="text">
                                <p>Hướng đến một cuộc sống “Eco” hòa hợp cùng thiên nhiên, tâm điểm khu biệt thự
                                    Vinhomes Đại Mỗ là <strong>hồ cảnh quan rộng 7.000 m2</strong>, bao quanh là các khu
                                    vườn cây xanh, đồi cỏ, thảm cỏ…. Tại đây, chủ sở hữu vừa có những giây phút thư giãn
                                    tuyệt vời cùng người thân, vừa được thỏa sức rèn luyện mình với các tiện ích thể
                                    thao độc đáo như bể bơi ngoài trời có mái che nằm sát mặt hồ, sân thể thao tennis,
                                    cầu lông, bóng chuyền hơi, bóng rổ, bóng bàn, GYM ngoài trời (20 máy tập)… Vinhomes
                                    Green Villas Đại Mỗ là một trong những khu biệt thự sở hữu không gian cảnh quan đẹp
                                    nhất của Vingroup, nối tiếp sau Vinhomes Green Bay, Vinhomes Riverside The Harmony.
                                </p>
                            </div>
                        </section>
                        <div class="flex_column av_one_full  flex_column_div av-zero-column-padding first  avia-builder-el-22  el_after_av_textblock  avia-builder-el-last  column-top-margin"
                            style="border-radius:0px; ">
                            <div class="av-horizontal-gallery av-horizontal-gallery-1px-gap av-horizontal-gallery-enlarge-effect av-horizontal-gallery-1 avia-builder-el-23 avia-builder-el-no-sibling av-control-default av-horizontal-gallery-animated"
                                itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject"
                                style="padding: 3.75% 0px;" data-av-enlarge="1.3" data-av-initial="2">
                                <div class="avia-slideshow-arrows avia-slideshow-controls"><a href="#prev"
                                        class="prev-slide av-horizontal-gallery-prev" aria-hidden="true"
                                        data-av_icon="" data-av_iconfont="entypo-fontello">Previous</a><a href="#next"
                                        class="next-slide av-horizontal-gallery-next" aria-hidden="true"
                                        data-av_icon="" data-av_iconfont="entypo-fontello">Next </a></div>
                                <div class="av-horizontal-gallery-inner" style="padding: 0px; height: 269px;"
                                    data-av-height="25">
                                    <div class="av-horizontal-gallery-slider"
                                        style="min-width: 1437.66px; left: -180.478px;">
        ...
        <div class="container">
            <div class="template-page content  av-content-full alpha units">
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:10px; "
                            class="av-special-heading av-special-heading-h2  blockquote modern-quote modern-centered  avia-builder-el-24  el_after_av_section  el_before_av_one_full  avia-builder-el-first  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Tiện ích đẳng cấp thừa hưởng của
                                Vinhomes Smart City</h2>
                            <div class="special-heading-border">
                                <div class="special-heading-inner-border"></div>
                            </div>
                        </div>
                        <div class="flex_column av_one_full  flex_column_div av-zero-column-padding first  avia-builder-el-25  el_after_av_heading  el_before_av_one_third  color-section "
                            style="border-radius:0px; ">
                            <div class="avia-image-container  av-styling-    avia-builder-el-26  avia-builder-el-no-sibling  image-background-2 avia-align-center "
                                itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
                                <div class="avia-image-container-inner">
                        ...
                        <div class="flex_column av_one_third  flex_column_div av-zero-column-padding first  avia-builder-el-27  el_after_av_one_full  el_before_av_two_third  column-top-margin"
                            style="border-radius:0px; ">
                            <div style="padding-bottom:10px; "
                                class="av-special-heading av-special-heading-h3  blockquote modern-quote modern-centered  avia-builder-el-28  el_before_av_textblock  avia-builder-el-first  ">
                                <h3 class="av-special-heading-tag " itemprop="headline">Vườn Nhật Bản</h3>
                                <div class="special-heading-border">
                                    <div class="special-heading-inner-border"></div>
                                </div>
                            </div>
                                ...
                                <div class="avia_textblock  " itemprop="text">
                                    <p><a href="http://localhost/vungnguyen/vuon-nhat-vinhomes-smart-city/">Vườn Nhật
                                        ...
                                        biệt thự Vinhomes Green Villas. Đây chính là <strong>khu vườn Nhật lớn nhất tại
                                            Việt Nam</strong>, tổng quy mô lên tới 6 ha, bao gồm các hạng mục: hồ cá
                                        chép đỏ, núi giả, rừng trúc, cầu gỗ, công viên đèn lồng, nhà hàng Nhật…</p>
                                    <p>Tại đây, cư dân biệt thự Vinhomes Đại Mỗ sẽ được hòa mình trong bầu không khí
                                        Nhật Bản, được tham dự các lễ hội, trò chơi truyền thống, đặc trưng của “xứ Phù
                                        Tang” như lễ hội đèn lồng, lễ hội thả cá chép, trò chơi ninja, phi tiêu… Vườn
                                        Nhật Tây Mỗ Đại Mỗ đã&nbsp;<strong>chính thức khánh thành từ tháng
                                            9/2019</strong>, chỉ mở cửa cho riêng cư dân nơi đây.</p>
                                </div>
                            </section>
                        </div>
                        <div class="flex_column av_two_third  flex_column_div av-zero-column-padding   avia-builder-el-30  el_after_av_one_third  el_before_av_two_third  color-section-2 column-top-margin"
                            style="border-radius:0px; ">
                            <div class="avia-image-container  av-styling-    avia-builder-el-31  avia-builder-el-no-sibling  image-background-2 avia-align-center "
                                itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
                                <div class="avia-image-container-inner">
                                    <div class="avia-image-overlay-wrap"><img loading="lazy"
                                            class="wp-image-32106 avia_image"
                        ...
                        <div class="flex_column av_two_third  flex_column_div av-zero-column-padding first  avia-builder-el-32  el_after_av_two_third  el_before_av_one_third  column-top-margin"
                            style="border-radius:0px; ">
                            <div class="avia-image-container  av-styling-    avia-builder-el-33  avia-builder-el-no-sibling  image-background-2 avia-align-center "
                                itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
                                <div class="avia-image-container-inner">
                                    <div class="avia-image-overlay-wrap"><img loading="lazy"
                        ...
                        <div class="flex_column av_one_third  flex_column_div av-zero-column-padding   avia-builder-el-34  el_after_av_two_third  el_before_av_section  avia-builder-el-last  column-top-margin"
                            style="border-radius:0px; ">
                            <div style="padding-bottom:10px; "
                                class="av-special-heading av-special-heading-h3  blockquote modern-quote modern-centered  avia-builder-el-35  el_before_av_textblock  avia-builder-el-first  ">
                                <h3 class="av-special-heading-tag " itemprop="headline">Vincom Mega Mall</h3>
                                <div class="special-heading-border">
                                    <div class="special-heading-inner-border"></div>
                                </div>
                            </div>
                            <section class="av_textblock_section " itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div class="avia_textblock  " itemprop="text">
                                    <p>Nằm đối diện với vườn Nhật, Vincom Mega Mall Tây Mỗ là một trong 3 khu trung tâm
                                        thương mại Vincom lớn nhất tại Hà Nội, bao gồm tất cả 3 tầng nổi, 5 cổng
                                        vào,&nbsp;<strong>tổng diện tích lên tới 68.000 m2</strong>. Tại Vincom Mega
                                        Mall Tây Mỗ, 100% các gian hàng thương mại đều sẽ được bố trí dựa trên yếu tố
                                        công nghệ, nhằm mang đến không gian mua sắm ấn tượng nhất tới mỗi khách hàng.
                                    </p>
                                    <p>Bên cạnh đó, Vincom Mega Mall Tây Mỗ còn sở hữu bãi đỗ xe ngoài trời thông minh,
                                        có thể chứa được 700 ô tô và 3.000 xe máy. Trong tương lai, nơi đây sẽ trở thành
                                        điểm mua sắm, giải trí hàng đầu tại khu vực phía Tây Hà Nội. Theo ước tính của
                                        Vincom Retail, Vincom Mega Mall Tây Mỗ có thể sẽ <strong>thu hút tới 1.8 triệu
                                            lượt khách hàng</strong>&nbsp;ngay từ năm đầu tiên hoạt động.</p>
                                </div>
                            </section>
                        </div>
                    </div>
    ...
    <div id="av_section_4"
        class="avia-section main_color avia-section-default avia-no-border-styling  avia-bg-style-scroll  avia-builder-el-37  el_after_av_one_third  el_before_av_tab_container  gradient-background  container_wrap fullsize"
        style=" ">
        <div class="container">
            <div class="template-page content  av-content-full alpha units">
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:30px; color:#ffffff;"
                            class="av-special-heading av-special-heading-h2 custom-color-heading blockquote modern-quote modern-centered  avia-builder-el-38  el_before_av_one_third  avia-builder-el-first  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Biệt thự Địa Trung Hải <span
                                    class="special_amp">“</span>có một không hai<span class="special_amp">”</span></h2>
                            <div class="special-heading-border">
                                <div class="special-heading-inner-border" style="border-color:#ffffff"></div>
                            </div>
                        </div>
                        <div class="flex_column av_one_third  flex_column_div av-zero-column-padding first  avia-builder-el-39  el_after_av_heading  el_before_av_two_third  "
                            style="border-radius:0px; ">
                            <section class="av_textblock_section " itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div class="avia_textblock  av_inherit_color " style="color:#ffffff; " itemprop="text">
                                    <p>Lấy cảm hứng từ những thành phố bên biển&nbsp;<strong>Địa Trung
                                            Hải</strong>,&nbsp;biệt thự Vinhomes Đại Mỗ được kiến tạo với mái hiên thấp,
                                        nhiều cửa có sổ diện tích lớn, giúp ánh sáng và gió trời luôn ngập tràn bên
                                        trong. Bên cạnh đó, mỗi căn biệt thự đều sở hữu sân vườn rộng quanh nhà, chủ sở
                                        hữu có thể tùy ý trồng cây cảnh hoặc đặt bàn cafe thưởng ngoạn cảnh quan thanh
                                        bình của cây xanh, hồ nước.</p>
                                    <p>Kiến trúc Địa Trung Hải là một trong những loại kiến trúc được ưa chuộng hàng đầu
                                        trong các dự án biệt thự của Vingroup bởi vẻ đẹp phóng khoáng và nghệ thuật. Đặc
                                        biệt, <strong>100% biệt thự Vinhomes Green Villas đều là biệt thự đơn
                                            lập</strong>, nên giá trị sống càng được nâng tầm, hứa hẹn sẽ trở thành nơi
                                        an cư hoàn hảo dành riêng cho giới thượng lưu thủ đô Hà Nội.</p>
                                </div>
                            </section>
                        </div>
                        <div class="flex_column av_two_third  flex_column_div av-zero-column-padding   avia-builder-el-41  el_after_av_one_third  avia-builder-el-last  color-section-2 "
                            style="border-radius:0px; ">
                            <div class="avia-image-container  av-styling-    avia-builder-el-42  avia-builder-el-no-sibling  image-background avia-align-center "
                                itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
                                <div class="avia-image-container-inner">
                                    <div class="avia-image-overlay-wrap"><img loading="lazy"
    ...
    <div id="after_section_4" class="main_color av_default_container_wrap container_wrap fullsize" style=" ">
        <div class="container">
            <div class="template-page content  av-content-full alpha units">
                <div class="post-entry post-entry-type-page post-entry-38255">
                    <div class="entry-content-wrapper clearfix">
                        <div class="tabcontainer   sidebar_tab sidebar_tab_left border_tabs  avia-builder-el-43  el_after_av_section  el_before_av_heading  avia-builder-el-first "
                            role="tablist">
                            <div class="tab_titles">
                                <div aria-controls="tab-id-1" role="tab" tabindex="0" data-fake-id="#tab-id-1"
                                    class="tab active_tab tab_counter_0" itemprop="headline">DL01</div>
                                <div aria-controls="tab-id-2" role="tab" tabindex="0" data-fake-id="#tab-id-2"
                                    class="tab tab_counter_1" itemprop="headline">DL02</div>
                                <div aria-controls="tab-id-3" role="tab" tabindex="0" data-fake-id="#tab-id-3"
                                    class="tab tab_counter_2" itemprop="headline">DL03</div>
                                <div aria-controls="tab-id-4" role="tab" tabindex="0" data-fake-id="#tab-id-4"
                                    class="tab tab_counter_3" itemprop="headline">DL04</div>
                                <div aria-controls="tab-id-5" role="tab" tabindex="0" data-fake-id="#tab-id-5"
                                    class="tab tab_counter_4" itemprop="headline">DL05</div>
                                <div aria-controls="tab-id-6" role="tab" tabindex="0" data-fake-id="#tab-id-6"
                                    class="tab tab_counter_5" itemprop="headline">DL06</div>
                                <div aria-controls="tab-id-7" role="tab" tabindex="0" data-fake-id="#tab-id-7"
                                    class="tab tab_counter_6" itemprop="headline">DL07</div>
                            </div>

                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-1" role="tab" tabindex="0" data-fake-id="#tab-id-1"
                                    class="tab active_tab fullsize-tab" itemprop="headline" aria-hidden="true">DL01
                                </div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-2" role="tab" tabindex="0" data-fake-id="#tab-id-2"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL02</div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-3" role="tab" tabindex="0" data-fake-id="#tab-id-3"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL03</div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-4" role="tab" tabindex="0" data-fake-id="#tab-id-4"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL04</div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-5" role="tab" tabindex="0" data-fake-id="#tab-id-5"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL05</div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-6" role="tab" tabindex="0" data-fake-id="#tab-id-6"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL06</div>
                            ...
                            <section class="av_tab_section" itemscope="itemscope"
                                itemtype="https://schema.org/CreativeWork">
                                <div aria-controls="tab-id-7" role="tab" tabindex="0" data-fake-id="#tab-id-7"
                                    class="tab fullsize-tab" itemprop="headline" aria-hidden="true">DL07</div>
                        ...
                        <div style="padding-bottom:10px; "
                            class="av-special-heading av-special-heading-h2  blockquote modern-quote modern-centered  avia-builder-el-44  el_after_av_tab_container  el_before_av_table  ">
                            <h2 class="av-special-heading-tag " itemprop="headline">Giá bán biệt thự Vinhomes Green
                                Villas</h2>
                            <div class="special-heading-border">
                                <div class="special-heading-inner-border"></div>
                            </div>
                        ...
                        <div class="avia-data-table-wrap avia_scrollable_table">
                            <table
                                class="avia-table avia-data-table avia-table-1  avia-builder-el-45  el_after_av_heading  el_before_av_textblock  avia_pricing_default "
                                itemscope="itemscope" itemtype="https://schema.org/Table">
                                <tbody>
                                    <tr class="avia-heading-row">
                                        <th class="">Loại hình</th>
                                        <th class="">Số lượng</th>
                                        <th class="">Diện tích</th>
                                        <th class="">Giá bán</th>
                                    </tr>
                                    <tr class="">
                                        <td class="">Biệt thự mặt hồ</td>
                                        <td class="">9 căn</td>
                                        <td class="">283.5 – 439.9 m2</td>
                                        <td class="">Hết hàng</td>
                                    </tr>
                                    <tr class="">
                                        <td class="">Biệt thự góc</td>
                                        <td class="">33 căn</td>
                                        <td class="">194 – 417.7 m2</td>
                                        <td class="">Hết hàng</td>
                                    </tr>
                                    <tr class="">
                                        <td class="">Biệt thự thường</td>
                                        <td class="">56 căn</td>
                                        <td class="">232.5 – 472.7 m2</td>
                                        <td class="">Hết hàng</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <section class="av_textblock_section " itemscope="itemscope"
                            itemtype="https://schema.org/CreativeWork">
                            <div class="avia_textblock  " itemprop="text">
                                <p>Dự án Vinhomes Green Villas Đại Mỗ &nbsp;đã được chúng tôi phân phối hết từ năm 2020.
                                    Nếu bạn đang quan tâm biệt thự tại đây, xin hãy vui lòng truy cập website đăng tin
                                    batdongsan.com.vn để tìm kiếm những căn đang được chủ nhà gửi bán lại. Trong trường
                    ...
                    <div class="post-entry post-entry-type-page post-entry-38255">
                        <div class="entry-content-wrapper clearfix">
                            <section class="av_textblock_section " itemscope="itemscope"
                                ...
                                <div class="avia_textblock  av_inherit_color " style="color:#ffffff; " itemprop="text">
                                    <p style="text-align: center;"><span
                                            style="font-size: 20px; text-transform: uppercase;">Đăng ký TƯ VẤN CHUYÊN
                                            SÂU DỰ ÁN</span></p>
                                </div>
                            </section>
                            <form action="http://localhost/vungnguyen/vinhomes-green-villas/" method="post"
                                ...
                                <fieldset>
                                    <p class="  first_form  form_element form_element_fourth" id="element_avia_1_1">
                                        <label for="avia_1_1">Họ và tên <abbr class="required"
                                    ...
                                    <p class="  form_element form_element_fourth" id="element_avia_4_1"><label
                                            for="avia_4_1">Dự án quan tâm</label> <input name="avia_4_1"
                                            class="text_input " type="text" id="avia_4_1" value=""
                                    ...
                                    <p class="form_element "><input type="hidden" value="1"
                                            name="avia_generated_form1"><input type="submit" value="ĐĂNG KÝ"
