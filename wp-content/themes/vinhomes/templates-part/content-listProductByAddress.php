...
<div id="av-tab-section-1"
    class="av-tab-section-container entry-content-wrapper main_color av-tab-no-transition   av-tab-above-content  avia-builder-el-1  el_after_av_fullscreen  el_before_av_section  submenu-not-first container_wrap fullsize"
    style=" ">
    <div class="av-tab-section-outer-container">
        <div class="av-tab-section-tab-title-container avia-tab-title-padding-small av-custom-tab-color"
            style="background-color: rgb(52, 85, 116); color: rgb(255, 255, 255); min-width: 390px; left: 0px;"
            role="tablist"><a href="#vinhomes-h-ni" data-av-tab-section-title="1"
                class="av-section-tab-title av-tab-no-icon av-tab-no-image av-active-tab-title" role="tab" tabindex="0"
                aria-controls="av-tab-section-1-1" style="color: rgb(255, 255, 255);"><span
                    class="av-outer-tab-title"><span class="av-inner-tab-title">VINHOMES HÀ NỘI</span></span><span
                    class="av-tab-arrow-container"><span></span></span></a><a href="#vinhomes-tp.hcm"
                data-av-tab-section-title="2" class="av-section-tab-title av-tab-no-icon av-tab-no-image" role="tab"
                tabindex="0" aria-controls="av-tab-section-1-2" style=""><span class="av-outer-tab-title"><span
                        class="av-inner-tab-title">VINHOMES TP.HCM</span></span><span
                    class="av-tab-arrow-container"><span></span></span></a><a href="#vinhomes-tnh-thnh"
                data-av-tab-section-title="3" class="av-section-tab-title av-tab-no-icon av-tab-no-image" role="tab"
                tabindex="0" aria-controls="av-tab-section-1-3" style=""><span class="av-outer-tab-title"><span
                        class="av-inner-tab-title">VINHOMES TỈNH THÀNH</span></span><span
                    class="av-tab-arrow-container"><span></span></span></a></div>
        <div class="av-tab-section-inner-container avia-section-small"
            style="width: 300vw; left: 0%; transform: translate3d(0%, 0px, 0px);"><span
                class="av_prev_tab_section av_tab_navigation"></span><span
                class="av_next_tab_section av_tab_navigation"></span>
            <div id="av-tab-section-1-1" data-av-tab-section-content="1"
                class="av-layout-tab av-animation-delay-container av-active-tab-content __av_init_open avia-builder-el-2 el_before_av_tab_sub_section avia-builder-el-first"
                style="vertical-align:middle; " data-av-tab-color="#ffffff" data-tab-section-id="vinhomes-h-ni">
                <div class="av-layout-tab-inner">
                    <div class="container">
                        <div data-autoplay="false" data-interval="5" data-animation="slide" data-show_slide_delay="30"
                            class="avia-content-slider-element-container avia-content-slider-element-slider avia-content-slider avia-smallarrow-slider avia-content-slider-active avia-content-slider1 avia-content-slider-even avia-builder-el-3 avia-builder-el-no-sibling">
                            ...
                            <div class="avia-content-slider-inner" style="padding: 0px; height: 203px;">
                                ...
                                <div class="slide-entry-wrap">
                                    ...
                                    <section
                                        class="slide-entry flex_column post-entry slide-entry-overview slide-loop-7 slide-parity-odd  av_one_fourth "
                                        itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                                        <div class="slide-entry-excerpt entry-content" itemprop="text">
                                            <p><a href="../vinhomes-skylake/"><img loading="lazy"
                                ...
                                <div class="slide-entry-wrap">
                                    ...
                                    <section
                                        class="slide-entry flex_column post-entry slide-entry-overview slide-loop-12 slide-parity-even  av_one_fourth "
                                        itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                                        <div class="slide-entry-excerpt entry-content" itemprop="text">
                                            <p><a href="../vinhomes-times-city/"><img loading="lazy"
            ...
            <div id="av-tab-section-1-2" data-av-tab-section-content="2"
                class="av-layout-tab av-animation-delay-container   avia-builder-el-4  el_after_av_tab_sub_section  el_before_av_tab_sub_section   "
                style="vertical-align:middle; " data-av-tab-color="#ffffff" data-tab-section-id="vinhomes-tp.hcm">
                <div class="av-layout-tab-inner">
                    <div class="container">
                        <div data-autoplay="false" data-interval="5" data-animation="slide" data-show_slide_delay="30"
                            class="avia-content-slider-element-container avia-content-slider-element-slider avia-content-slider avia-smallarrow-slider avia-content-slider-active avia-content-slider2 avia-content-slider-even avia-builder-el-5 avia-builder-el-no-sibling">
                            <div class="avia-smallarrow-slider-heading  no-content-slider-heading ">
                                <div class="new-special-heading">&nbsp;</div>
                            </div>
                            <div class="avia-content-slider-inner" style="padding: 0px; height: 203px;">
                                <div class="slide-entry-wrap active-slide"
                                    ...
                                    <section
                                        ...
                                        itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                                        <div class="slide-entry-excerpt entry-content" itemprop="text">
                                            <p><a href="../vinhomes-golden-river/"><img loading="lazy"
            ...
            <div id="av-tab-section-1-3" data-av-tab-section-content="3"
                class="av-layout-tab av-animation-delay-container   avia-builder-el-6  el_after_av_tab_sub_section  avia-builder-el-last   "
                style="vertical-align:middle; " data-av-tab-color="#ffffff" data-tab-section-id="vinhomes-tnh-thnh">
                <div class="av-layout-tab-inner">
                    <div class="container">
                        <div data-autoplay="false" data-interval="5" data-animation="slide" data-show_slide_delay="30"
                            class="avia-content-slider-element-container avia-content-slider-element-slider avia-content-slider avia-smallarrow-slider avia-content-slider-active avia-content-slider3 avia-content-slider-even avia-builder-el-7 avia-builder-el-no-sibling">
                            <div class="avia-smallarrow-slider-heading  no-content-slider-heading ">
                                <div class="new-special-heading">&nbsp;</div>
                                <div class="avia-slideshow-arrows avia-slideshow-controls"><a href="#prev"
                                        class="prev-slide" aria-hidden="true" data-av_icon=""
                            ...
                            <div class="avia-content-slider-inner" style="padding: 0px; height: 228px;">
                                <div class="slide-entry-wrap active-slide"
                                    style="visibility: visible; opacity: 1; transition: none 0s ease 0s; transform: translateZ(0px);">
                                    <section
                                        class="slide-entry flex_column post-entry slide-entry-overview slide-loop-1 slide-parity-odd  av_one_fourth first"
                                ...
                                <div class="slide-entry-wrap">
                                    <section
                                        ...
                                        itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                                        <div class="slide-entry-excerpt entry-content" itemprop="text">
                                            <p><a href="../vinhomes-imperia/"><img loading="lazy"
                                                        class="alignnone wp-image-21043 size-full"
                                                        src="../wp-content/uploads/2019/05/vinhomes-imperia.jpg"
                                                        alt="vinhomes-imperia" width="800" height="450"></a></p>
                                            <p style="text-align: center;"><a href="../vinhomes-imperia/">Vinhomes
                                                    Imperia</a></p>
                                        </div>
                                    </section>
                                    <section
                                        class="slide-entry flex_column post-entry slide-entry-overview slide-loop-6 slide-parity-even  post-entry-last  av_one_fourth "
                                        itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                                        <div class="slide-entry-excerpt entry-content" itemprop="text">
                                            <p><a href="../vinhomes-dragon-bay/"><img loading="lazy"
